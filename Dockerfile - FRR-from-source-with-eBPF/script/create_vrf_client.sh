...
# Prompt the user to input the interface name
read -p "Enter the interface name connected with the VRF: " INT_NAME
...
/sbin/ip link set dev $INT_NAME master $VRF_NAME
